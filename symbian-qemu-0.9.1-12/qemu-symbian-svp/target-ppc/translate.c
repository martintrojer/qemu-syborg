...
/* 5 bits unsigned immediate value */
...
/* FIXME: This is old dyngen based AltiVec code. It should probably justi
   be ripped out once the TCG based stuff is merged.  */
#if 0
OP_VR_ST_TABLE(vebx);
GEN_VR_STX(vebx, 0x07, 0x04);
OP_VR_ST_TABLE(vehx);
GEN_VR_STX(vehx, 0x07, 0x05);
OP_VR_ST_TABLE(vewx);
GEN_VR_STX(vewx, 0x07, 0x06);
...
GEN_HANDLER(mtvscr, 0x04, 0x2, 0x19, 0x03ff0000, PPC_ALTIVEC)
{
    ...
    gen_load_avr(0, rB(ctx->opcode));
    gen_op_store_vscr_A0 ();
}

#define GEN_VR_VXFORM(name, xo)                                 \
  ...
  {                                                                     \
    ...
    gen_load_avr(0, rA(ctx->opcode));                                   \
    gen_load_avr(1, rB(ctx->opcode));                                   \
    gen_op_##name ();                                                   \
    gen_store_avr(rD(ctx->opcode), 0);                                  \
  }

#define GEN_VR_VXFORM_UIMM(name, xo)            \
  GEN_HANDLER(name, 0x04, (xo >> 1) & 0x1f, (xo >> 6) & 0x1f, 0x00000000, PPC_ALTIVEC) \
  {                                                                     \
    target_ulong uimm = UIMM5(ctx->opcode);                             \
    if (unlikely(!ctx->altivec_enabled)) {                              \
      GEN_EXCP_NO_VR(ctx);                                              \
      return;                                                           \
    }                                                                   \
    tcg_gen_movi_tl(cpu_T[0], uimm);                                    \
    gen_load_avr(1, rB(ctx->opcode));                                   \
    gen_op_##name ();                                                   \
    gen_store_avr(rD(ctx->opcode), 0);                                  \
  }

#define GEN_VR_VXFORM_SIMM(name, xo)            \
  GEN_HANDLER(name, 0x04, (xo >> 1) & 0x1f, (xo >> 6) & 0x1f, 0x0000f800, PPC_ALTIVEC) \
  {                                                                     \
    target_ulong simm = SIMM5(ctx->opcode);                             \
    if (unlikely(!ctx->altivec_enabled)) {                              \
      GEN_EXCP_NO_VR(ctx);                                              \
      return;                                                           \
    }                                                                   \
...
#define GEN_VR_VXFORM_NOA(name, xo)             \
...
GEN_VR_VXFORM(vaddubm, 0);
GEN_VR_VXFORM(vadduhm, 64);
GEN_VR_VXFORM(vadduwm, 128);
GEN_VR_VXFORM(vaddcuw, 384);
GEN_VR_VXFORM(vaddubs, 512);
GEN_VR_VXFORM(vadduhs, 576);
GEN_VR_VXFORM(vadduws, 640);
GEN_VR_VXFORM(vaddsbs, 768);
GEN_VR_VXFORM(vaddshs, 832);
GEN_VR_VXFORM(vaddsws, 896);
GEN_VR_VXFORM(vsububm, 1024);
GEN_VR_VXFORM(vsubuhm, 1088);
GEN_VR_VXFORM(vsubuwm, 1152);
GEN_VR_VXFORM(vsubcuw, 1408);
GEN_VR_VXFORM(vsububs, 1536);
GEN_VR_VXFORM(vsubuhs, 1600);
GEN_VR_VXFORM(vsubuws, 1664);
GEN_VR_VXFORM(vsubsbs, 1792);
GEN_VR_VXFORM(vsubshs, 1856);
GEN_VR_VXFORM(vsubsws, 1920);
GEN_VR_VXFORM(vmaxub, 2);
GEN_VR_VXFORM(vmaxuh, 66);
GEN_VR_VXFORM(vmaxuw, 130);
GEN_VR_VXFORM(vmaxsb, 258);
GEN_VR_VXFORM(vmaxsh, 322);
GEN_VR_VXFORM(vmaxsw, 386);
GEN_VR_VXFORM(vminub, 514);
GEN_VR_VXFORM(vminuh, 578);
GEN_VR_VXFORM(vminuw, 642);
GEN_VR_VXFORM(vminsb, 770);
GEN_VR_VXFORM(vminsh, 834);
GEN_VR_VXFORM(vminsw, 898);
GEN_VR_VXFORM(vavgub, 1026);
GEN_VR_VXFORM(vavguh, 1090);
GEN_VR_VXFORM(vavguw, 1154);
GEN_VR_VXFORM(vavgsb, 1282);
GEN_VR_VXFORM(vavgsh, 1346);
GEN_VR_VXFORM(vavgsw, 1410);
GEN_VR_VXFORM(vrlb, 4);
GEN_VR_VXFORM(vrlh, 68);
GEN_VR_VXFORM(vrlw, 132);
GEN_VR_VXFORM(vslb, 260);
GEN_VR_VXFORM(vslh, 324);
GEN_VR_VXFORM(vslw, 388);
GEN_VR_VXFORM(vsl, 452);
GEN_VR_VXFORM(vsrb, 516);
GEN_VR_VXFORM(vsrh, 580);
GEN_VR_VXFORM(vsrw, 644);
GEN_VR_VXFORM(vsr, 708);
GEN_VR_VXFORM(vsrab, 772);
GEN_VR_VXFORM(vsrah, 836);
GEN_VR_VXFORM(vsraw, 900);
GEN_VR_VXFORM(vand, 1028);
GEN_VR_VXFORM(vandc, 1092);
GEN_VR_VXFORM(vor, 1156);
GEN_VR_VXFORM(vnor, 1284);
/* mfvscr and mtvscr implemented separately */
GEN_VR_VXFORM(vmuloub, 8);
GEN_VR_VXFORM(vmulouh, 72);
GEN_VR_VXFORM(vmulosb, 264);
GEN_VR_VXFORM(vmulosh, 328);
GEN_VR_VXFORM(vmuleub, 520);
GEN_VR_VXFORM(vmuleuh, 584);
GEN_VR_VXFORM(vmulesb, 776);
GEN_VR_VXFORM(vmulesh, 840);
GEN_VR_VXFORM(vsum4ubs, 1544);
GEN_VR_VXFORM(vsum4sbs, 1800);
GEN_VR_VXFORM(vsum4shs, 1608);
GEN_VR_VXFORM(vsum2sws, 1672);
GEN_VR_VXFORM(vsumsws, 1928);
GEN_VR_VXFORM(vaddfp, 10);
GEN_VR_VXFORM(vsubfp, 74);
GEN_VR_VXFORM_NOA(vrefp, 266);
GEN_VR_VXFORM_NOA(vrsqrtefp, 330);
GEN_VR_VXFORM_NOA(vexptefp, 394);
GEN_VR_VXFORM_NOA(vlogefp, 458);
GEN_VR_VXFORM_NOA(vrfin, 522);
GEN_VR_VXFORM_NOA(vrfiz, 586);
GEN_VR_VXFORM_NOA(vrfip, 650);
GEN_VR_VXFORM_NOA(vrfim, 714);
GEN_VR_VXFORM_UIMM(vcfux, 778);
GEN_VR_VXFORM_UIMM(vcfsx, 842);
GEN_VR_VXFORM_UIMM(vctuxs, 906);
GEN_VR_VXFORM_UIMM(vctsxs, 970);
GEN_VR_VXFORM(vmaxfp, 1034);
GEN_VR_VXFORM(vminfp, 1098);
GEN_VR_VXFORM(vmrghb, 12);
GEN_VR_VXFORM(vmrghh, 76);
GEN_VR_VXFORM(vmrghw, 140);
GEN_VR_VXFORM(vmrglb, 268);
GEN_VR_VXFORM(vmrglh, 332);
GEN_VR_VXFORM(vmrglw, 396);
GEN_VR_VXFORM_UIMM(vspltb, 524);
GEN_VR_VXFORM_UIMM(vsplth, 588);
GEN_VR_VXFORM_UIMM(vspltw, 652);
GEN_VR_VXFORM_SIMM(vspltisb, 780);
GEN_VR_VXFORM_SIMM(vspltish, 844);
GEN_VR_VXFORM_SIMM(vspltisw, 908);
GEN_VR_VXFORM(vslo, 1036);
GEN_VR_VXFORM(vsro, 1100);
GEN_VR_VXFORM(vpkuhum, 14);
GEN_VR_VXFORM(vpkuwum, 78);
GEN_VR_VXFORM(vpkuhus, 142);
GEN_VR_VXFORM(vpkuwus, 206);
GEN_VR_VXFORM(vpkshus, 270);
GEN_VR_VXFORM(vpkswus, 334);
GEN_VR_VXFORM(vpkshss, 398);
GEN_VR_VXFORM(vpkswss, 462);
GEN_VR_VXFORM_NOA(vupkhsb, 526);
GEN_VR_VXFORM_NOA(vupkhsh, 590);
GEN_VR_VXFORM_NOA(vupklsb, 654);
GEN_VR_VXFORM_NOA(vupklsh, 718);
GEN_VR_VXFORM(vpkpx, 782);
GEN_VR_VXFORM_NOA(vupkhpx, 846);
GEN_VR_VXFORM_NOA(vupklpx, 974);
GEN_VR_VXFORM(vxor, 1220);

#define GEN_VR_VXRFORM1(opname, name, str, xo, rc)                       \
  ...
  {                                                                     \
    ...
    gen_store_avr(rD(ctx->opcode), 0);                                  \
    if (rc) {                                                           \
      tcg_gen_mov_i32(cpu_crf[6], cpu_T[0]);                           \
    }                                                                   \
  }
    
#define GEN_VR_VXRFORM(name, xo)                                        \
  GEN_VR_VXRFORM1(name, name, #name, xo, 0)                             \
  GEN_VR_VXRFORM1(name, name##_, #name ".", xo, 1)

GEN_VR_VXRFORM(vcmpbfp, 966);
GEN_VR_VXRFORM(vcmpeqfp, 198);
GEN_VR_VXRFORM(vcmpequb, 6)
GEN_VR_VXRFORM(vcmpequh, 70)
GEN_VR_VXRFORM(vcmpequw, 134)
GEN_VR_VXRFORM(vcmpgefp, 454)
GEN_VR_VXRFORM(vcmpgtfp, 710)
GEN_VR_VXRFORM(vcmpgtsb, 774)
GEN_VR_VXRFORM(vcmpgtsh, 838)
GEN_VR_VXRFORM(vcmpgtsw, 902)
GEN_VR_VXRFORM(vcmpgtub, 518)
GEN_VR_VXRFORM(vcmpgtuh, 582)
GEN_VR_VXRFORM(vcmpgtuw, 646)

#define GEN_VR_VAFORM_PAIRED(name0, name1, xo)                          \
...
GEN_VR_VAFORM_PAIRED(vmhaddshs, vmhraddshs, 32)
...
GEN_VR_VAFORM_PAIRED(vmsumubm, vmsummbm, 36)
GEN_VR_VAFORM_PAIRED(vmsumuhm, vmsumuhs, 38)
GEN_VR_VAFORM_PAIRED(vmsumshm, vmsumshs, 40)
GEN_VR_VAFORM_PAIRED(vsel, vperm, 42)
GEN_VR_VAFORM_PAIRED(vmaddfp, vnmsubfp, 46)

GEN_HANDLER(vsldoi, 0x04, 0x16, 0xFF, 0x00000400, PPC_ALTIVEC)
{
  target_ulong sh = VSH(ctx->opcode);
  if (unlikely(!ctx->altivec_enabled)) {
    GEN_EXCP_NO_VR(ctx);
    return;
  }
